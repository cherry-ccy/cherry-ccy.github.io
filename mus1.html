        ...
        <body>
            ...
            <!-- Main jumbotron for a primary marketing message or call to action -->
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-6">
                            <p style="text-align:center"><span style="font-size:20px"> <span style="color:#ff0000">假<br/>装<br/>这<br/>里<br/>有<br/>专<br/>辑<br/>图</span></span></p>
                        </div>
                        <div class="col-md-6">
                            <p style="text-align:center"><span style="font-size:20px"> <span style="color:#ff0000">假<br/>装<br/>这<br/>里<br/>有<br/>lyric</span></span></p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="span12">
                            <p style="text-align:center"><span style="font-size:20px"> <span style="color:#ff0000">假装这里有音乐媒体</span></span></p>
                        </div>
                    </div>
                </div>
