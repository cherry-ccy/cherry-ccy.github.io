            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-8 blog-main">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <h2 class="blog-post-title"><a href="pic1.jsp">相册一</a></h2>
                                <p style="text-align:center"><span style="font-size:20px"> <span style="color:#ff0000">只有聪明的人才能看得到相册</span></span></p>
                            </div>
                            <div class="col-md-4">
                                <h2 class="blog-post-title"><a href="pic2.jsp">相册二</a></h2>
                                <p style="text-align:center"><span style="font-size:20px"> <span style="color:#ff0000">只有聪明的人才能看得到相册</span></span></p>
                            </div>
                            <div class="col-md-4">
                                <h2 class="blog-post-title"><a href="pic3.jsp">相册三</a></h2>
                                <p style="text-align:center"><span style="font-size:20px"> <span style="color:#ff0000">只有聪明的人才能看得到相册</span></span></p>
                            </div>
                        </div>
                        <nav>
